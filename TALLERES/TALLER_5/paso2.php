...
function mostrarInventario($inv) {
    foreach ($inv as $producto => $info) {
        echo "<br>$producto: {$info['cantidad']} unidades, Precio: {$info['precio']}<br>";
    }
}
...
echo "<br>Producto con mayor valor total en inventario: {$productoMayor['producto']} (Valor: \${$productoMayor['valor']})<br>";
?>
